                ...
                <div className="flex items-center gap-2 mt-3 pt-3 border-t border-white/10">
                  {b.status === 'pending' && (
                    <button onClick={() => setActionTarget({ bookingId: b.id, action: 'confirm', booking: b })}
                      className="text-xs font-medium bg-green-500/20 text-green-400 px-3 py-2 rounded-lg hover:bg-green-500/30 min-h-[36px] transition-colors flex items-center gap-1 flex-shrink-0"
                  ...
                  {/* WhatsApp: pending → Send Confirm (one time) | confirmed → Send Reminder */}
                  {b.customerPhone && b.status === 'pending' && !confirmSent.has(b.id) && (
                    <button
                      onClick={() => sendWhatsApp(b, 'confirm')}
                      className="flex-1 min-w-0 text-xs font-medium bg-green-600/20 text-green-400 px-3 py-2 rounded-lg hover:bg-green-600/30 min-h-[36px] transition-colors flex items-center justify-center gap-1.5"
                  ...
                  {b.customerPhone && b.status === 'confirmed' && (
                    <button
                      onClick={() => sendWhatsApp(b, 'reminder')}
                      className="flex-1 min-w-0 text-xs font-medium bg-amber-500/20 text-amber-400 px-3 py-2 rounded-lg hover:bg-amber-500/30 min-h-[36px] transition-colors flex items-center justify-center gap-1.5"
